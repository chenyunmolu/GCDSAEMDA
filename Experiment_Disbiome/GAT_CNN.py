...
if __name__ == '__main__':
    ...
    microbe_similarity_fusion_matrix = pd.read_csv('../Dataset/Disbiome/microbe_similarity_fusion_matrix.csv',
                                                   index_col=0)
    disease_similarity_fusion_matrix = pd.read_csv('../Dataset/Disbiome/disease_similarity_fusion_matrix.csv',
                                                   index_col=0)
