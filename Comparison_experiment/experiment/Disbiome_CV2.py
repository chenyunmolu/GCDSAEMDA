...
# 基于Disbiome数据库的CV2的ROC曲线绘制
plt.figure(figsize=(10, 8))

sheetName = 'Disbiome_CV2_AUC'
...
plt.plot(GCDSAEMDA[0], GCDSAEMDA[1], color="#D81C38", lw=2, label='GCDSAEMDA(AUC=%0.4f)' % mean_auc)
...
plt.savefig('./Disbiome_CV2_AUC.png')
plt.show()

# 基于Disbiome数据库的CV2的PR曲线绘制
plt.figure(figsize=(10, 8))
sheetName = 'Disbiome_CV2_AUPR'
GCDSAEMDA = pd.read_excel('../GCDSAEMDA.xlsx', sheet_name=sheetName, header=None)
...
plt.savefig('./Disbiome_CV2_AUPR.png')
plt.show()
