...
# 基于Disbiome数据库的CV1的ROC曲线绘制
plt.figure(figsize=(10, 8))

sheetName = 'Disbiome_CV1_AUC'
...
plt.savefig('./Disbiome_CV1_AUC.png')
plt.show()

# 基于Disbiome数据库的CV1的PR曲线绘制
plt.figure(figsize=(10, 8))
sheetName = 'Disbiome_CV1_AUPR'
GCDSAEMDA = pd.read_excel('../GCDSAEMDA.xlsx', sheet_name=sheetName, header=None)
...
plt.savefig('./Disbiome_CV1_AUPR.png')
plt.show()
