...
# 基于Disbiome数据库的CV3的ROC曲线绘制
plt.figure(figsize=(10, 8))

sheetName = 'Disbiome_CV3_AUC'
...
plt.savefig('./Disbiome_CV3_AUC.png')
plt.show()

# 基于Disbiome数据库的CV3的PR曲线绘制
plt.figure(figsize=(10, 8))
sheetName = 'Disbiome_CV3_AUPR'
GCDSAEMDA = pd.read_excel('../GCDSAEMDA.xlsx', sheet_name=sheetName, header=None)
...
plt.savefig('./Disbiome_CV3_AUPR.png')
plt.show()
