...
# 基于Disbiome数据库实现CV1、CV2、CV3的AUC值，可视化为柱状图

randomSample_CV1 = pd.read_excel('../GCDSAEMDA_KMeans.xlsx', sheet_name='Disbiome_CV1_randomSample_AUC', header=None)
randomSample_cv1_auc = auc(randomSample_CV1[0], randomSample_CV1[1])
randomSample_CV2 = pd.read_excel('../GCDSAEMDA_KMeans.xlsx', sheet_name='Disbiome_CV2_randomSample_AUC', header=None)
randomSample_cv2_auc = auc(randomSample_CV2[0], randomSample_CV2[1])
randomSample_CV3 = pd.read_excel('../GCDSAEMDA_KMeans.xlsx', sheet_name='Disbiome_CV3_randomSample_AUC', header=None)
randomSample_cv3_auc = auc(randomSample_CV3[0], randomSample_CV3[1])

KMeans_CV1 = pd.read_excel('../GCDSAEMDA_KMeans.xlsx', sheet_name='Disbiome_CV1_KMeans_AUC', header=None)
KMeans_cv1_auc = auc(KMeans_CV1[0], KMeans_CV1[1])
KMeans_CV2 = pd.read_excel('../GCDSAEMDA_KMeans.xlsx', sheet_name='Disbiome_CV2_KMeans_AUC', header=None)
KMeans_cv2_auc = auc(KMeans_CV2[0], KMeans_CV2[1])
KMeans_CV3 = pd.read_excel('../GCDSAEMDA_KMeans.xlsx', sheet_name='Disbiome_CV3_KMeans_AUC', header=None)
KMeans_cv3_auc = auc(KMeans_CV3[0], KMeans_CV3[1])

cosineKMeans_CV1 = pd.read_excel('../GCDSAEMDA.xlsx', sheet_name='Disbiome_CV1_AUC', header=None)
cosineKMeans_cv1_auc = auc(cosineKMeans_CV1[0], cosineKMeans_CV1[1])
cosineKMeans_CV2 = pd.read_excel('../GCDSAEMDA.xlsx', sheet_name='Disbiome_CV2_AUC', header=None)
cosineKMeans_cv2_auc = auc(cosineKMeans_CV2[0], cosineKMeans_CV2[1])
cosineKMeans_CV3 = pd.read_excel('../GCDSAEMDA.xlsx', sheet_name='Disbiome_CV3_AUC', header=None)
...
plt.xlabel('Disbiome dataset', fontsize='xx-large')
...
plt.savefig('./Disbiome_KMeans_AUC.png')
plt.show()

# 基于Disbiome数据库实现CV1、CV2、CV3的AUC值，可视化为柱状图

randomSample_CV1 = pd.read_excel('../GCDSAEMDA_KMeans.xlsx', sheet_name='Disbiome_CV1_randomSample_AUPR', header=None)
randomSample_cv1_aupr = auc(randomSample_CV1[0], randomSample_CV1[1])
randomSample_CV2 = pd.read_excel('../GCDSAEMDA_KMeans.xlsx', sheet_name='Disbiome_CV2_randomSample_AUPR', header=None)
randomSample_cv2_aupr = auc(randomSample_CV2[0], randomSample_CV2[1])
randomSample_CV3 = pd.read_excel('../GCDSAEMDA_KMeans.xlsx', sheet_name='Disbiome_CV3_randomSample_AUPR', header=None)
randomSample_cv3_aupr = auc(randomSample_CV3[0], randomSample_CV3[1])

KMeans_CV1 = pd.read_excel('../GCDSAEMDA_KMeans.xlsx', sheet_name='Disbiome_CV1_KMeans_AUPR', header=None)
KMeans_cv1_aupr = auc(KMeans_CV1[0], KMeans_CV1[1])
KMeans_CV2 = pd.read_excel('../GCDSAEMDA_KMeans.xlsx', sheet_name='Disbiome_CV2_KMeans_AUPR', header=None)
KMeans_cv2_aupr = auc(KMeans_CV2[0], KMeans_CV2[1])
KMeans_CV3 = pd.read_excel('../GCDSAEMDA_KMeans.xlsx', sheet_name='Disbiome_CV3_KMeans_AUPR', header=None)
KMeans_cv3_aupr = auc(KMeans_CV3[0], KMeans_CV3[1])

cosineKMeans_CV1 = pd.read_excel('../GCDSAEMDA.xlsx', sheet_name='Disbiome_CV1_AUPR', header=None)
cosineKMeans_cv1_aupr = auc(cosineKMeans_CV1[0], cosineKMeans_CV1[1])
cosineKMeans_CV2 = pd.read_excel('../GCDSAEMDA.xlsx', sheet_name='Disbiome_CV2_AUPR', header=None)
cosineKMeans_cv2_aupr = auc(cosineKMeans_CV2[0], cosineKMeans_CV2[1])
cosineKMeans_CV3 = pd.read_excel('../GCDSAEMDA.xlsx', sheet_name='Disbiome_CV3_AUPR', header=None)
...
plt.legend(loc='upper center', framealpha=0, bbox_to_anchor=(0.5, 1.1), ncol=3, fontsize='xx-large')
plt.savefig('./Disbiome_KMeans_AUPR.png')
plt.show()
